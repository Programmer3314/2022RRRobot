...
//HIGH
        ...
        targetPointsHigh.add(new TargetPoint(-5.2, 1250, 70, 2500, 5));
        targetPointsHigh.add(new TargetPoint(-4.8, 1250, 70, 2500, 5));
        targetPointsHigh.add(new TargetPoint(-4.2, 2000, 20, 2500, 5));
        targetPointsHigh.add(new TargetPoint(-3.8, 2000, 20, 2500, 5)); 
        targetPointsHigh.add(new TargetPoint(-3.2, 2000, 20, 2500, 5));
        targetPointsHigh.add(new TargetPoint(-2.8, 2000, 20, 2500, 5));
